...
public class Main extends AppCompatActivity {
    ...
    private AdapterQ QouterAdapter;
    private List<QueteMaska> Quotelist = new ArrayList<>();

    private  AdapterF FeelingsAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        QouterAdapter = new AdapterQ(Main.this, Quotelist);
        ...
        FeelingsAdapter = new AdapterF(feelingsMaska,Main.this);
